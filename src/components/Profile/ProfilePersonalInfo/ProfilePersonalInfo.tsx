                ...
                <AppBar position="static" color={'secondary'}>
                    ...
                    <Box className={s.inner}>
                        ...
                        <Grid container direction="row" justify="space-between" alignItems="center">
                            ...
                            {isOwner ?
                                <Grid item><Button color="primary" onClick={handleEditClick}>Edit</Button></Grid> :
                                <Grid item><Button color="primary" >Start
                                    Dialog</Button></Grid>
                            }
                        </Grid>
...
export default withRouter(connect
    ...
    (mapStateToProps, {
        getUser,
        changeAvatar,
        setEditingSuccess: actions.setEditingSuccess,
        editProfile
    })(ProfilePersonalInfo))
